...
return [
    ...
    'modules' => [
        'site' => [
            'class' => 'kouosl\site\zimmetmodul'   // here is our v1 modules
        ], 
        'menu' => [
            'class' => 'kouosl\menu\zimmetmodul',
            ],
        'user' => [
            'class' => 'kouosl\user\zimmetmodul'   // here is our v1 modules
        ],
        'sample' => [
            'class' => 'kouosl\sample\zimmetmodul'   // here is our v1 modules
        ]
